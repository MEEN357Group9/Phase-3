% p3task5  Drives the  2017 Texas A&M race car of Phase 1 over the
% speed bump roadway using forcing-function data structures f_2017_1, f_2017_2, f_2017_3
% f_2017_4, f_2017_5, and f_2017_6.
%
% Phase 3, Task 5
...
title('Heave Displacement of 2017 Car over Cobblestone');
xlabel('Time [s]');
...
legend('1/4 Car 1 DOF','1/4 Car 2 DOF','1/2 Car 2 DOF','1/2 Car 4 DOF', ...
    'Full Car 3 DOF','Full Car 7 DOF');
title('Heave Velocity of 2017 Car over Cobblestone');
xlabel('Time [s]');
...
legend('1/4 Car 1 DOF','1/4 Car 2 DOF','1/2 Car 2 DOF','1/2 Car 4 DOF', ...
    'Full Car 3 DOF','Full Car 7 DOF');
title('Heave Acceleration of 2017 Car over Cobblestone');
xlabel('Time [s]');
...
title('Pitch Displacement of 2017 Car over Cobblestone');
xlabel('Time [s]');
ylabel('Rotation [deg]');
...
legend('1/2 Car 2 DOF','1/2 Car 4 DOF','Full Car 3 DOF','Full Car 7 DOF');
title('Pitch Velocity of 2017 Car over Cobblestone');
xlabel('Time [s]');
...
legend('1/2 Car 2 DOF','1/2 Car 4 DOF','Full Car 3 DOF','Full Car 7 DOF');
title('Pitch Acceleration of 2017 Car over Cobblestone');
xlabel('Time [s]');
...
title('Roll Displacement of 2017 Car over Cobblestone');
xlabel('Time [s]');
ylabel('Rotation [deg]');
...
legend('Full Car 3 DOF','Full Car 7 DOF');
title('Roll Velocity of 2017 Car over Cobblestone');
xlabel('Time [s]');
ylabel('Velocity [deg/s]');
...
legend('Full Car 3 DOF','Full Car 7 DOF');
title('Roll Acceleration of 2017 Car over Cobblestone');
xlabel('Time [s]');
ylabel('Acceleration [deg/s^2]');
...
title('Heave Displacement for 2017 Car');
xlabel('Time [s]');
...
legend('Axle Plane','Chassis Plane');
title('Pitch Displacement for 2017 Car');
xlabel('Time [s]');
...
legend('Axle Plane','Chassis Plane');
title('Roll Displacement for 2017 Car');
xlabel('Time [s]');
...
plot(T6,warp_a,'r');
legend('Axle Plane');
title('Warp of Axle Plane for 2017 Car');
xlabel('Time [s]');
